 ...
 */
package com.mycompany.meza.perpustakaan.controller;



import com.mycompany.meza.perpustakaan.FormPengembalian;
import com.mycompany.meza.perpustakaan.model.Pengembalian;
import com.mycompany.meza.perpustakaan.service.PengembalianService;
...
public class PengembalianController {
    ...
    public void getPengembalianId(){
        ...
        Pengembalian pengembalian = (Pengembalian) pengembalianService.getPengembalian(id);
    ...
    public void savePengembalian() {
        ...
        pengembalian = (Pengembalian) pengembalianService.savePengembalian(pengembalian);
        if (pengembalian != null) {
     ...
     public void updatePengembalian() {
        ...
        pengembalian = (Pengembalian) pengembalianService.updatePengembalian(pengembalian);
        if (pengembalian != null) {
            formPengembalian.getTxtPengembalianId().setText(pengembalian.getPengembalianId().toString());
